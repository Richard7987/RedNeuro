---
title: 07 Métricas con desbalance
---

# 07 Métricas con desbalance

Anterior: [06 Entrenamiento](06-entrenamiento.md). Siguiente: [08 Visualización en vivo](08-visualizacion-en-vivo.md). Índice: [RedNeuro: cómo se hizo](index.md).
...
> **⚠️ Elegir el umbral mirando el test es hacer trampa**
>
...
- **Pesos de clase en la BCE.** Multiplicar el término de los positivos por un factor es otra forma de subir recall, cambiando lo que la red aprende y no solo el umbral. Toca `binary_cross_entropy` y `dZ2`, y el [05 Gradient check](05-gradient-check.md) diría si quedó bien.
