---
title: 05 Gradient check
---

# 05 Gradient check

Anterior: [04 La red](04-la-red.md). Siguiente: [06 Entrenamiento](06-entrenamiento.md). Índice: [RedNeuro: cómo se hizo](index.md).
...
En [06 Entrenamiento](06-entrenamiento.md) la pérdida baja bien a la primera. Sin el gradient check, que baje no dice mucho: una red con un gradiente medio mal (por ejemplo `db1` con el eje equivocado) muchas veces también baja, solo que peor y sin que sepas por qué. Con el test pasando, cualquier problema que aparezca después ya no es de las derivadas, y eso descarta la mitad de los sospechosos.
