...
1. [01 Entorno con Nix](01-entorno-con-nix.md) — flake.nix, `nix develop`, y el detalle de git que hace que el flake no vea archivos nuevos.
2. [02 Datos HTRU2](02-datos-htru2.md) — descarga, exploración, y el archivo con fines de línea raros.
3. [03 Preprocesamiento](03-preprocesamiento.md) — split estratificado, z-score con estadísticas de train, y por qué X tiene shape (8, m).
4. [04 La red](04-la-red.md) — init, forward, pérdida y backward. Qué es igual al notebook original y qué cambia por ser binario.
5. [05 Gradient check](05-gradient-check.md) — la prueba que demuestra que las derivadas están bien.
6. [06 Entrenamiento](06-entrenamiento.md) — el loop, la pérdida bajando, y los experimentos con el learning rate.
7. [07 Métricas con desbalance](07-metricas-con-desbalance.md) — por qué accuracy engaña, precision, recall, F1 y el umbral.
8. [08 Visualización en vivo](08-visualizacion-en-vivo.md) — ver la red trabajando candidato por candidato.

Aparte:
- [Errores y lecciones](errores-y-lecciones.md) — todo lo que falló y qué significaba cada error.
- [Glosario](glosario.md) — los términos, explicados corto.
- [Comandos](comandos.md) — chuleta para correr todo.
...
La pérdida (binary cross-entropy) baja de 1.12 a 0.075 en 1000 iteraciones. Con umbral 0.35 la red encuentra 270 de los 327 púlsares del test. Detalles en [07 Métricas con desbalance](07-metricas-con-desbalance.md).
