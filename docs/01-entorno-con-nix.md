---
title: 01 Entorno con Nix
---

# 01 Entorno con Nix

Volver al índice: [RedNeuro: cómo se hizo](index.md). Siguiente: [02 Datos HTRU2](02-datos-htru2.md).
...
Aclaración sobre las librerías: la red es NumPy puro. `scikit-learn` solo se usa para verificar que mis métricas dan lo mismo que las suyas ([07 Métricas con desbalance](07-metricas-con-desbalance.md)), y `pytest` para el [05 Gradient check](05-gradient-check.md).
...
Nada grave. Ver [Fase 1](errores-y-lecciones.md#fase-1) por un typo con la virgulilla que dejó a bash buscando un usuario llamado jupyter.
