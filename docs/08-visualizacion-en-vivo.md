---
title: 08 Visualización en vivo
---

# 08 Visualización en vivo

Anterior: [07 Métricas con desbalance](07-metricas-con-desbalance.md). Índice: [RedNeuro: cómo se hizo](index.md).
...
> **⚠️ Nunca una pausa en cero**
>
> `plt.pause(0)` con un backend sin ventana significa "espera indefinidamente". Lo descubrí en una prueba automatizada que se quedó colgada seis minutos a 0% de CPU. Detalles en [Fase 8](errores-y-lecciones.md#fase-8).
