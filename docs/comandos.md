...
Índice: [RedNeuro: cómo se hizo](index.md). Todo se corre desde la raíz del repo (`~/Projects/Redneuro`) y dentro de `nix develop`.
...
Detalles y perillas en [08 Visualización en vivo](08-visualizacion-en-vivo.md).
...
Recordar que dentro del notebook la ruta al CSV lleva `..` adelante ([Fase 2](errores-y-lecciones.md#fase-2)).
...
Si el repo es git, el flake solo ve archivos que git conoce ([01 Entorno con Nix](01-entorno-con-nix.md)):
